...
<!-- stylesheets -->
<link rel="stylesheet" href="resources/styles/operatuk.css"
	type="text/css" media="all" />

<!-- other icons -->
<link rel="icon" type="image/png"
	href="https://www.operat.co.uk/getfile/design/favicon.png" />
<link rel="image_src"
	href="https://www.operat.co.uk/getfile/design/social.png" />
...
<body class="lo-singlepage lo-home" itemscope itemtype="http://schema.org/WebPage">
				...
				<ul class="lvl-0">
					...
					<ul class="lvl-1">
							<li class="lvl-1-item"><a
								href="https://www.operat.co.uk/frequently-asked-questions"
					...
					<li class="lvl-0-item"><a
						href="https://www.operat.co.uk/contact-us" class="lvl-0-link">Contact
							Us</a></li>
				</ul>
			</nav>
	...
	<div class="region  region--content" id="main-content" itemprop="mainContentOfPage">
		...
		<div class="container--offset--left">
			...
			<h1 class="widthline">OPERAT Environmetrics Properties</h1>
	
	
			<article class="article--default">
				<p>Exploratory factor analysis indicated that a four factor model provided an optimal fit to the assessment data collected in 405 postcode areas in Wales. This model included domains capturing <em>Natural Elements, Incivilities and Nuisance; Territorial Functioning and Navigation and Mobility</em>. See the <a href="background.htm">Background to OPERAT</a> for more details .</p>
				<p>Convergent validity was examined by estimating correlations between the OPERAT domains, residents' perceptions of their neighbourhood (the extent to which they enjoyed living in the area, felt that it was a desirable place to live, or felt safe at night or during the day) and neighbourhood characteristics (levels of deprivation, geographic settlement type). See the <a href="operat-publications.htm">published article</a> on the development of OPERAT for full details.</p>
				<p>Ten postcode areas were selected to assess inter-rater reliability. Krippendorff's Alpha was greater than the acceptable threshold (0.8) for all items.</p>
				<p> </p>		
			</article>
				...
				<div class="footer-nav">
					...
					<ul class="footer-lvl-0">
						<li class="footer-lvl-0-item"><a
							href="https://www.operat.co.uk/sitemap" class="footer-lvl-0-link">Site
								Map</a></li>
						<li class="footer-lvl-0-item"><a
						...
						<li class="footer-lvl-0-item"><a
							href="https://www.operat.co.uk/contact-us"
